...
import {addProduct,listProduct,removeProduct,singleProduct,publicSingleProduct,updateImg,updateProduct,uploadDescriptionImage} from '../controllers/productController.js'
...
productRoute.get('/single/:productKey', publicSingleProduct)
