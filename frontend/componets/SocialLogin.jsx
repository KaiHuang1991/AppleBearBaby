    ...
    <div className='w-full sm:max-w-96 mx-auto mt-6 px-2'>
      ...
      <div className='flex flex-col items-center gap-3'>
        <a
          ...
          className={`w-[280px] flex items-center justify-center gap-2 border border-gray-300 bg-white text-gray-800 py-2.5 px-4 text-sm font-medium shadow-sm hover:bg-gray-50 ${
