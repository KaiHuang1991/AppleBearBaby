...
const RELATED_LINKS = [
  {
    key: 'facebook',
    label: 'Facebook',
    href: 'https://www.facebook.com/Applebear88',
    icon: (
  ...
  },
  {
    key: 'instagram',
    label: 'Instagram',
    href: 'https://www.instagram.com/hjyd1234/',
    icon: (
      <svg className='w-5 h-5' viewBox='0 0 24 24' aria-hidden='true'>
        <defs>
  ...
  },
  {
    key: 'tiktok',
    label: 'TikTok',
    href: 'https://www.tiktok.com/@applebearhu888',
    icon: (
      <svg className='w-5 h-5' viewBox='0 0 24 24' aria-hidden='true'>
        <path
          fill='#FE2C55'
            ...
            <div className='grid grid-cols-2 gap-3 w-fit'>
              {RELATED_LINKS.map(({ key, label, href, icon }) => (
                <a
                  ...
                  aria-label={label}
                  title={label}
                  className='inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white hover:border-slate-300 hover:shadow-sm transition-all'
                >
                  {icon}
                </a>
              ))}
